...
function App() {
  const style = {
    ...
    cardBody: `w-full h-full bg-neutralWhite p-20 rounded-3xl border border-neutralLightGrey shadow`,
    ...
    inputStyle: `border-neutralLightGrey text-neutralOffBlack font-bold text-2xl px-3 w-1/2 h-10 mt-3 border-2 rounded hover:border-primary focus:ring-2 focus:ring-primary focus:outline-none focus:border-none transition-all`,
